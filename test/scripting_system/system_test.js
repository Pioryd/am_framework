...
describe("System test", () => {
  ...
  it("Parse", () => {
    const system = new System(root, root.source.systems["Test_system_ID"]);

    expect(system.get_id()).to.equal("Test_system_ID");
    expect(system.get_name()).to.equal("Test_system");
